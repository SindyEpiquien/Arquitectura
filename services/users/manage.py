...
def seed_db():
    """Seeds the database."""
    db.session.add(User(username='raquel', email="raquel@gmail.com", password='greaterthaneight'))
    db.session.add(User(username='sindy', email="sindyepiquien@upeu.edu.pe", password='greaterthaneight'))
    db.session.commit()
